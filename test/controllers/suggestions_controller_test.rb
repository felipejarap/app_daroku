...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { comment: @suggestion.comment, description: @suggestion.description, type_sugestion_id: @suggestion.type_sugestion_id, user_id: @suggestion.user_id } }
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { comment: @suggestion.comment, description: @suggestion.description, type_sugestion_id: @suggestion.type_sugestion_id, user_id: @suggestion.user_id } }

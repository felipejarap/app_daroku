...
class MunicipalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipality" do
    assert_difference('Municipality.count') do
      post municipalities_url, params: { municipality: { description: @municipality.description } }
    end
  ...
  test "should update municipality" do
    patch municipality_url(@municipality), params: { municipality: { description: @municipality.description } }
